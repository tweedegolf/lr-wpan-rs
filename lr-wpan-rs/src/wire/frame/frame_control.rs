...
impl FrameVersion {
    ...
    ///
    /// ``` rust
    /// use lr_wpan_rs::wire::FrameVersion;
    ///
...
/// # Example
/// ```rust
/// use lr_wpan_rs::wire::{Address, AddressMode, PanId, ShortAddress};
///
...
impl AddressMode {
    ...
    ///
    /// ``` rust
    /// use lr_wpan_rs::wire::AddressMode;
    /// // decode
